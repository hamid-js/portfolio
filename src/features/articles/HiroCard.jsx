...
export default function HiroCard() {
  return (
    <div className="mb-5 flex flex-col items-center justify-center rounded-b-xl bg-[var(--primary-color-2)] md:mt-2    md:gap-3 md:text-xl md:shadow-md md:shadow-green-500">
      <video
        autoPlay
        loop
        muted

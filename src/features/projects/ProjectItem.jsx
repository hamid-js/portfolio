...
export default function ProjectItem() {
  ...
  return (
    <>
      <div className=" mb-10 flex flex-col items-center justify-evenly gap-0 rounded-md bg-[var(--primary-color-700)] pt-5  ">
...
<Title
        ...
        <p className="px-10 py-0 text-center capitalize  xl:text-sm  ">
        ...
        <div className=" flex w-full items-center justify-between text-lg capitalize  ">
          <a className={`${hover} py-2 mx-8 `} href="#">
            <span>

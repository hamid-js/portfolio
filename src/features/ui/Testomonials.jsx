    ...
    <div className=" my-5 flex flex-col items-start justify-evenly gap-8  rounded-lg bg-[var(--primary-color-800)] pb-20    ">
      ...
      <div className="flex flex-col items-center justify-center px-7 ">
        ...
        <div className="flex w-full items-center justify-evenly ">
          ...
          <img
            className="h-28 w-28 rounded-full border-2 border-[var(--secondary-color-500)] 2xl:my-5  2xl:h-40  2xl:w-40 "
        ...
        <span className="mt-5 font-medium capitalize 2xl:mt-10 2xl:text-3xl ">
          Helen Floyd
        </span>
        <span className="--primary-color-300 text-sm 2xl:mt-3 2xl:text-2xl">
          {' '}
          Art Director{' '}
        </span>
        <ul className="mt-7 flex  2xl:mt-20">
          <li className="mx-2 h-3 w-3 cursor-pointer rounded-full  bg-[--color-white] active:bg-[var(--secondary-color-500)] 2xl:h-5 2xl:w-5"></li>
          <li className="mx-2 h-3 w-3 cursor-pointer rounded-full bg-[var(--secondary-color-500)] active:bg-[var(--secondary-color-500)] 2xl:h-5 2xl:w-5"></li>
          <li className="mx-2 h-3 w-3 cursor-pointer rounded-full  bg-[--color-white] active:bg-[var(--secondary-color-500)] 2xl:h-5 2xl:w-5"></li>
        </ul>
      </div>
    </div>
